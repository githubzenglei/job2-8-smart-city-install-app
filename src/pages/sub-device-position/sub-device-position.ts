...
@IonicPage()
@Component({
  selector: 'page-sub-device-position',
  templateUrl: 'sub-device-position.html',
})
export class SubDevicePositionPage {
  ...
  constructor(public navCtrl: NavController, 
    ...
    this.devicePname = navParams.get('devicePname');
    this.subdevice.modelId = navParams.get('modelId');
    this.gwmodelId = navParams.get('pmodelId');
  ...
  ionViewDidEnter() {
    this.binding = 0;
    this.getPositionByDeviceName(this.devicePname, this.gwmodelId);
